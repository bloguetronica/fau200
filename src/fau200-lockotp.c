/* FAU200 LockOTP Command - Version 1.1 for Debian Linux
...
int main(int argc, char **argv)
{
    ...
    else
    {
        ...
        {
            libusb_device_handle *devhandle = libusb_open_device_with_vid_pid_serial(context, 0x10C4, 0x8C35, (unsigned char *)argv[1]);  // Open the device having the specified serial number, and get the device handle
